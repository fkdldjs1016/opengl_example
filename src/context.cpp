...
bool Context::Init() {
  ...
  float vertices[] = {
    0.5f, 0.5f, 0.0f, 0.5f, 1.0f, 0.0f, // top right, green
    0.5f, -0.5f, 1.0f, 1.0f, 1.0f, 1.0f, // bottom right, green
    -0.5f, -0.5f, 1.0f, 0.5f, 0.5f, 1.0f, // bottom left, pink
    -0.5f, 0.5f, 1.0f, 0.5f, 1.0f, 1.0f, // top left, yellow
  };
